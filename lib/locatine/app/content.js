...
async function refreshData(){
  if (!document.getElementById("locatine_magic_div")){
    const options = {
      ...
      "locatinetitle": await get_value('locatine_title') || "Right now you are defining nothing. So no button will work",
      "locatinehint": await get_value('locatine_hint') || "But you can click it anyway :)"
    };
    ...
    if (await get_value('locatine_title') != magicDiv.getAttribute("locatinetitle")) {
